local MissionData = {
    ...
    ["MissionDetails"] = {
        ...
        { Node = "Exta", Planet = "Ceres", Type = "Assassination", Tileset = "Grineer Shipyard", Enemy = "Grineer", MinLevel = 14, MaxLevel = 16, Tier = "Kril and Vor 2", LinkName = "Captain Vor and Lieutenant Lech Kril", Pic = "Vor Krill Icon.png", Drops = {"Frost","Miter","Twin Gremlins"}},
        ...
        { Node = "Nereid", Planet = "Neptune", Type = "Spy", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 30, MaxLevel = 32, Tier = "Spy3"},
        ...
        { Node = "Kappa", Planet = "Sedna", Type = "Spy", Tileset = "Grineer Galleon", Enemy = "Grineer", MinLevel = 34, MaxLevel = 38, Tier = "Spy3"},
        ...
        { Node = "Kelpie", Planet = "Sedna", Type = "Disruption", Tileset = "Grineer Galleon", Enemy = "Grineer", MinLevel = 35, MaxLevel = 40, Tier = "DisruptionSedna"},
...
-- Empyrean
        --{ Node = "Free Flight", Planet = "Earth Proxima", Type = "Landscape|Free Roam", Tileset = "Free Space"},
        { Node = "Posit Cluster", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 15, MaxLevel = 20, Tier = "EarthProxima", FighterMinLevel = 1, FighterMaxLevel = 3, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Sover Strait", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 20, MaxLevel = 20, Tier = "EarthProxima", FighterMinLevel = 3, FighterMaxLevel = 3, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Rian Belt", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 17, MaxLevel = 20, Tier = "EarthProxima", FighterMinLevel = 6, FighterMaxLevel = 9, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Phanghoul Satellites", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 20, MaxLevel = 28, Tier = "EarthProxima", FighterMinLevel = 3, FighterMaxLevel = 6, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Ogal Cluster", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 26, MaxLevel = 30, Tier = "EarthProxima", FighterMinLevel = 9, FighterMaxLevel = 12, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Minhast Station", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 28, MaxLevel = 33, Tier = "EarthProxima", FighterMinLevel = 12, FighterMaxLevel = 15, MaxFighters = 30, MaxCrewships = 2, Objectives = 0},
        { Node = "Jex Lanes", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 32, MaxLevel = 38, Tier = "EarthProxima", FighterMinLevel = 13, FighterMaxLevel = 17, MaxFighters = 60, MaxCrewships = 4, Objectives = 1},
        { Node = "Bendar Cluster", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 38, MaxLevel = 42, Tier = "EarthProxima", FighterMinLevel = 16, FighterMaxLevel = 19, MaxFighters = 60, MaxCrewships = 4, Objectives = 1},
        { Node = "Iota Temple", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 45, MaxLevel = 57, Tier = "EarthProxima", FighterMinLevel = 18, FighterMaxLevel = 23, MaxFighters = 60, MaxCrewships = 4, Objectives = 1},
        { Node = "Korms Belt", Planet = "Earth Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 43, MaxLevel = 53, Tier = "EarthProxima", FighterMinLevel = 20, FighterMaxLevel = 25, MaxFighters = 60, MaxCrewships = 4, Objectives = 1, ObjectiveDetails = 'Chance for Galleon Assassinate'},
        ...
        { Node = "Vila Gap", Planet = "Saturn Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 62, MaxLevel = 70, Tier = "SaturnProxima", FighterMinLevel = 27, FighterMaxLevel = 30, MaxFighters = 60, MaxCrewships = 4, Objectives = 1},
        ...
        { Node = "Spiro Gap", Planet = "Saturn Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 58, MaxLevel = 63, Tier = "SaturnProxima", FighterMinLevel = 25, FighterMaxLevel = 28, MaxFighters = 60, MaxCrewships = 4, Objectives = 1},
        ...
        { Node = "Ganalen's Grave", Planet = "Veil Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 80, MaxLevel = 90, Tier = "VeilProxima", FighterMinLevel = 35, FighterMaxLevel = 57, MaxFighters = 90, MaxCrewships = 6, Objectives = 2},
        ...
        { Node = "Rya", Planet = "Veil Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 80, MaxLevel = 90, Tier = "VeilProxima", FighterMinLevel = 34, FighterMaxLevel = 36, MaxFighters = 90, MaxCrewships = 6, Objectives = 2},
        { Node = "Gian Point", Planet = "Veil Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 80, MaxLevel = 90, Tier = "VeilProxima", FighterMinLevel = 35, FighterMaxLevel = 37, MaxFighters = 90, MaxCrewships = 6, Objectives = 0},
        { Node = "Flexa", Planet = "Veil Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 80, MaxLevel = 90, Tier = "VeilProxima", FighterMinLevel = 36, FighterMaxLevel = 39, MaxFighters = 90, MaxCrewships = 6, Objectives = 2, ObjectiveDetails = '1 is a Galleon Assassinate'},
        { Node = "Ruse War Field", Planet = "Veil Proxima", Type = "Skirmish", Tileset = "Free Space", Enemy = "Grineer", MinLevel = 80, MaxLevel = 90, Tier = "VeilProxima", FighterMinLevel = 42, FighterMaxLevel = 45, MaxFighters = 90, MaxCrewships = 6, Objectives = 1, ObjectiveDetails = '1 additional optional Derelict can spawn'},
    },
    by={Name={}},dictionary={},
    vars={
        'Node',
