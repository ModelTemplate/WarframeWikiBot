local DropData = {
    ["Missions"] = {
        ...
        { Type = "Defense",
          ...
          Rewards = {
            ["A"] = {
                {"Vitality","Mod",6.90},
                {"Fast Deflection","Mod",6.90},
                {"Rush","Mod",7.37},
                {"Magazine Warp","Mod",6.90},
                {"Trick Mag","Mod",6.90},
            ...
            ["C"] = {
                ...
                {"Streamline","Mod",1.84},
                {"Intensify","Mod",1.84},
                {"Thunderbolt","Mod",0.40},
                {"Endo","Endo",7.59,80},
                {"Endo","Endo",1.84,80},
                {"True Punishment","Mod",0.40},
                {"Quickening","Mod",0.40},
                {"Enduring Strike","Mod",0.40},
                {"Life Strike","Mod",0.40},
                {"Meso C6","Relic",7.59},
                {"Meso P2","Relic",7.59},
                {"Meso K3","Relic",7.59},
                {"Meso P4","Relic",7.59},
        ...
        { Type = "Disruption",
          ...
          Rewards = {
            ...
            ["C"] = {
                {"Hexenon","Resource",30.00,15},
                {"Axi A11","Relic",5.00},
                {"Axi O5","Relic",5.00},
                {"Axi A13","Relic",5.00},
                {"Proton Snap","Mod",10.00},
                {"Motus Setup","Mod",10.00},
                {"Aero Agility","Mod",10.00},
                {"Universal Medallion","Resource",5.00},
                {"Axi W2","Relic",5.00},
                {"Axi C6","Relic",5.00},
                {"Axi Z1","Relic",5.00},
                {"Axi T6","Relic",5.00},
        ...
        { Type = "Disruption",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",100.00,20000},
            },
            ["B"] = {
                {"Credits Cache","Credits",100.00,30000},
            },
            ["C"] = {
                {"Credits Cache","Credits",95.00,50000},
                {"Universal Medallion","Resource",5.00},
            },
          },
        },
        { Type = "Disruption",
          ...
          Rewards = {
            ...
            ["C"] = {
                ...
                {"Universal Medallion","Resource",5.10},
                {"Axi W2","Relic",10.20},
                {"Axi C6","Relic",10.20},
                {"Axi Z1","Relic",10.20},
                {"Axi T6","Relic",10.20},
        ...
        { Type = "Disruption",
          ...
          Rewards = {
            ["A"] = {
                {"Kuva","Resource",100.00,100},
            },
            ["B"] = {
                {"Kuva","Resource",100.00,200},
            },
            ["C"] = {
                {"Kuva","Resource",95.00,350},
                {"Universal Medallion","Resource",5.00},
            },
          },
        },
        ...
        { Type = "Excavation",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",25.00,3000},
                {"Credits Cache","Credits",25.00,3000},
                {"Credits Cache","Credits",25.00,3000},
                {"Endo","Endo",25.00,400},
            },
        ...
        { Type = "Exterminate",
          ...
          Rewards = {
            ...
            ["C"] = {
                ...
                {"Endo","Endo",15.10,600},
                {"Endo","Endo",4.40,600},
                {"Orokin Cell","Resource",15.10},
                {"Gallium","Resource",15.10},
                {"Neurodes","Resource",15.10},
                {"Orokin Cell","Resource",4.40,2},
                {"Gallium","Resource",4.40,2},
                {"Neurodes","Resource",4.40,2},
                {"Tellurium","Resource",4.40},
                {"Argon Crystal","Resource",1.00},
                {"Nitain Extract","Resource",1.00},
                {"Xiphos Engines Blueprint","Blueprint",0.50},
            },
          },
        },
        { Type = "Exterminate",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",100.00,10000},
            },
            ["B"] = {
                {"Endo","Endo",12.65,400},
                {"Endo","Endo",12.65,400},
            ...
            ["C"] = {
                ...
                {"Nitain Extract","Resource",2.00},
                {"Xiphos Avionics Blueprint","Blueprint",0.50},
            },
          },
        },
        { Type = "Exterminate",
        ...
        { Type = "Interception",
          ...
          Rewards = {
            ...
            ["B"] = {
                {"Superior Defenses","Mod",10.00},
                {"Bleeding Edge","Mod",10.00},
                {"Superior Defenses","Mod",10.00},
                {"Argon Plating","Mod",10.00},
                {"Furor","Mod",10.00},
                {"Glacial Edge","Mod",10.00},
                {"Electrified Barrel","Mod",10.00},
                {"Energy Inversion","Mod",10.00},
                {"Endo","Endo",10.00,250},
                {"Endo","Endo",10.00,250},
            },
            ["C"] = {
        ...
        { Type = "Sabotage",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",100.00,2500},
            },
            ["B"] = {
            ...
            ["C"] = {
                ...
                {"Forma Blueprint","Blueprint",2.00},
                {"Forma","Resource",0.50},
            },
          },
        },
        { Type = "Sabotage",
          ...
          Rewards = {
            ...
            ["C"] = {
                {"Endo","Endo",15.10,80},
                {"Endo","Endo",15.10,150},
                {"Morphics","Resource",15.10},
                {"Gallium","Resource",15.10},
                {"Neurodes","Resource",15.10},
                {"Morphics","Resource",5.50,2},
                {"Gallium","Resource",5.50,2},
                {"Neurodes","Resource",5.50,2},
                {"Endo","Endo",5.50,160},
                {"Argon Crystal","Resource",0.67},
                {"Tellurium","Resource",0.67},
                {"Nitain Extract","Resource",0.67},
                {"Xiphos Fuselage Blueprint","Blueprint",0.50},
            },
          },
        },
        { Type = "Sabotage",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",100.00,5000},
            },
            ["B"] = {
                {"Endo","Endo",12.65,400},
                {"Endo","Endo",12.65,400},
        ...
        { Type = "Sabotage",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",20.00,3000},
                {"Credits Cache","Credits",20.00,3000},
                {"Polymer Bundle","Resource",20.00,300},
                {"Endo","Endo",20.00,200},
                {"Endo","Endo",20.00,200},
            },
            ["B"] = {
        ...
        { Type = "Spy",
          ...
          Rewards = {
            ...
            ["C"] = {
                {"Master Key","Mod",10.00},
                {"Reflection","Mod",10.00},
                {"Parry","Mod",10.00},
                {"Heavy Impact","Mod",10.00},
                {"Serration","Mod",10.00},
                {"Hornet Strike","Mod",10.00},
                {"Metal Auger","Mod",10.00},
                {"Volcanic Edge","Mod",10.00},
                {"Vicious Frost","Mod",10.00},
                {"Ivara Systems Blueprint","Blueprint",10.00},
            },
          },
        },
        { Type = "Spy",
        ...
        { Type = "Survival",
          ...
          Rewards = {
            ...
            ["B"] = {
                {"Mutalist Alad V Nav Coordinate","Resource",12.50},
                {"Neo T2","Relic",12.50},
                {"Neo N14","Relic",12.50},
                {"Neo N13","Relic",12.50},
                {"Neo Z7","Relic",12.50},
        ...
        { Type = "Survival",
          ...
          Rewards = {
            ["A"] = {
                {"Credits Cache","Credits",50.00,2000},
                {"Endo","Endo",50.00,100},
            },
            ["B"] = {
                {"Parry","Mod",7.69},
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Meso C6 (Radiant)","Relic",5.53},
                {"Lith D4 (Radiant)","Relic",9.48},
                {"Lith B8 (Radiant)","Relic",9.48},
                {"Lith G3 (Radiant)","Relic",9.48},
                {"Lith P5 (Radiant)","Relic",9.48},
                {"Lith T5 (Radiant)","Relic",9.48},
                {"Lith I1 (Radiant)","Relic",9.48},
                {"Meso K3 (Radiant)","Relic",5.53},
                {"Lith T4 (Radiant)","Relic",9.48},
            },
            ["B"] = {
                {"Synthetic Eidolon Shard","Resource",10.84},
                {"Endo","Endo",10.84,400},
                {"Meso P4 (Radiant)","Relic",10.84},
                ...
                {"Neo N14 (Radiant)","Relic",4.42},
                {"Neo Z7 (Radiant)","Relic",4.42},
                {"Meso D6 (Radiant)","Relic",10.84},
                {"Meso T4 (Radiant)","Relic",10.84},
                {"Neo N13 (Radiant)","Relic",4.42},
            },
            ["C"] = {
                {"Endo","Endo",15.18,750},
                ...
                {"Axi Z1 (Radiant)","Relic",2.01},
                {"Neo T2 (Radiant)","Relic",15.18},
                {"Neo P2 (Radiant)","Relic",15.18},
                {"Axi A11 (Radiant)","Relic",2.01},
                {"Axi A13 (Radiant)","Relic",2.01},
                {"Axi W2 (Radiant)","Relic",2.01},
                {"Neo B7 (Radiant)","Relic",15.18},
                {"Axi C6 (Radiant)","Relic",2.01},
                {"Axi T6 (Radiant)","Relic",2.01},
                {"Neo N15 (Radiant)","Relic",15.18},
            },
          },
        },
        { Type = "Arbitrations",
          ...
          Rewards = {
            ["A"] = {
                {"Ayatan Valana Sculpture","Ayatan Sculpture",9.00},
                {"Ayatan Sah Sculpture","Ayatan Sculpture",9.00},
                {"Ayatan Ayr Sculpture","Ayatan Sculpture",9.00},
                {"Vitus Essence","Resource",7.00,3},
                {"Arcane Pistoleer","Resource",5.00},
                {"Arcane Tanker","Resource",5.00},
                {"Arcane Bodyguard","Resource",5.00},
                {"Combat Discipline","Mod",2.00},
                {"Adaptation","Mod",2.00},
                {"Aerodynamic","Mod",2.00},
                {"Aura Forma Blueprint","Blueprint",1.00},
                {"Endo","Endo",44.00,900},
            },
            ["B"] = {
                {"Ayatan Vaya Sculpture","Ayatan Sculpture",12.00},
                {"Ayatan Piv Sculpture","Ayatan Sculpture",12.00},
                {"Vitus Essence","Resource",7.00,3},
                {"Arcane Bodyguard","Resource",5.00},
                {"Arcane Blade Charger","Resource",5.00},
                {"Arcane Primary Charger","Resource",5.00},
                {"Combat Discipline","Mod",2.50},
                {"Adaptation","Mod",2.50},
                {"Shepherd","Mod",2.50},
                {"Aura Forma Blueprint","Blueprint",2.00},
                {"Endo","Endo",44.50,1200},
            },
            ["C"] = {
                {"Ayatan Orta Sculpture","Ayatan Sculpture",20.00},
                {"Vitus Essence","Resource",7.00,3},
                {"Arcane Pistoleer","Resource",5.00},
                {"Arcane Tanker","Resource",5.00},
                {"Arcane Blade Charger","Resource",5.00},
                {"Arcane Primary Charger","Resource",5.00},
                {"Combat Discipline","Mod",3.50},
                {"Melee Guidance","Mod",3.50},
                {"Swift Momentum","Mod",3.50},
                {"Seeding Step Ephemera Blueprint","Blueprint",5.00},
                {"Aura Forma Blueprint","Blueprint",4.50},
                {"Endo","Endo",33.00,1500},
            },
          },
        },
        { Type = "Tactical Alert",
        ...
        { Type = "Granum Void",
          ...
          Rewards = {
            ...
            ["B"] = {
                {"Credits Cache","Credits",50.00,3000},
                {"Endo","Endo",33.33,200},
        ...
        { Type = "Granum Void",
          ...
          Rewards = {
            ...
            ["B"] = {
                {"Credits Cache","Credits",50.00,5000},
                {"Endo","Endo",33.33,400},
        ...
        { Type = "Event",
          Tier = "Normal",
          Name = "Orphix Venom Normal",
          Alias = "Orphix Venom Normal",
          ShortName = "[[Operation: Orphix Venom]]",
          Ignore = true,
          Rewards = {
            ["A"] = {
                {"Necramech Aviator","Mod",2.50},
                {"Necramech Rage","Mod",2.50},
                {"Necramech Enemy Sense","Mod",2.50},
                {"Necramech Deflection","Mod",2.50},
                {"Necramech Rebuke","Mod",2.50},
                {"Necramech Repair","Mod",2.50},
                {"Necramech Augur","Mod",2.50},
                {"Lith D4","Relic",5.00},
                {"Lith B8","Relic",5.00},
                {"Lith G3","Relic",5.00},
                {"Lith P5","Relic",5.00},
            ...
            ["B"] = {
                {"Cedo Blueprint","Blueprint",2.00},
                {"Cedo Barrel","Blueprint",2.00},
                {"Cedo Receiver","Blueprint",2.00},
                {"Cedo Stock","Blueprint",2.00},
                {"Meso P4","Relic",8.00},
                {"Meso C6","Relic",8.00},
                {"Meso I1","Relic",8.00},
                {"Meso P2","Relic",8.00},
            ...
            ["C"] = {
                {"Lavos Blueprint","Blueprint",2.00},
                {"Lavos Chassis Blueprint","Blueprint",2.00},
                {"Lavos Neuroptics Blueprint","Blueprint",2.00},
                {"Lavos Systems Blueprint","Blueprint",2.00},
                {"Lavos Cordatus Helmet Blueprint","Blueprint",2.00},
                {"Neo T2","Relic",8.00},
                {"Neo N14","Relic",8.00},
                {"Neo N13","Relic",8.00},
                {"Neo Z7","Relic",8.00},
		...
		{ Type = "Event",
          Tier = "Advanced",
          Name = "Orphix Venom Advanced",
          Alias = "Orphix Venom Advanced",
          ShortName = "[[Operation: Orphix Venom]]",
          Ignore = true,
          Rewards = {
            ["A"] = {
                {"Necramech Aviator","Mod",3.00},
                {"Necramech Rage","Mod",3.00},
                {"Necramech Enemy Sense","Mod",3.00},
                {"Necramech Deflection","Mod",3.00},
                {"Necramech Rebuke","Mod",3.00},
                {"Necramech Repair","Mod",3.00},
                {"Necramech Augur","Mod",3.00},
                {"Lith D4","Relic",6.00},
                {"Lith B8","Relic",6.00},
                {"Lith G3","Relic",6.00},
                {"Lith P5","Relic",6.00},
            ...
            ["B"] = {
                {"Cedo Blueprint","Blueprint",3.00},
                {"Cedo Barrel","Blueprint",3.00},
                {"Cedo Receiver","Blueprint",3.00},
                {"Cedo Stock","Blueprint",3.00},
                {"Meso P4","Relic",6.00},
                {"Meso C6","Relic",6.00},
                {"Meso I1","Relic",6.00},
                {"Meso P2","Relic",6.00},
            ...
            ["C"] = {
                {"Lavos Blueprint","Blueprint",3.00},
                {"Lavos Chassis Blueprint","Blueprint",3.00},
                {"Lavos Neuroptics Blueprint","Blueprint",3.00},
                {"Lavos Systems Blueprint","Blueprint",3.00},
                {"Lavos Cordatus Helmet Blueprint","Blueprint",3.00},
                {"Neo T2","Relic",6.00},
                {"Neo N14","Relic",6.00},
                {"Neo N13","Relic",6.00},
                {"Neo Z7","Relic",6.00},
        ...
        { Type = "Event",
          Tier = "Endurance",
          Name = "Orphix Venom Endurance",
          Alias = "Orphix Venom Endurance",
          ShortName = "[[Operation: Orphix Venom]]",
          Ignore = true,
          Rewards = {
            ["A"] = {
                {"Lavos Blueprint","Blueprint",4.00},
                {"Lavos Chassis Blueprint","Blueprint",4.00},
                {"Lavos Neuroptics Blueprint","Blueprint",4.00},
                {"Lavos Systems Blueprint","Blueprint",4.00},
                {"Lavos Cordatus Helmet Blueprint","Blueprint",8.00},
                {"Neo T2","Relic",8.00},
                {"Neo N14","Relic",8.00},
                {"Neo N13","Relic",8.00},
                {"Neo Z7","Relic",8.00},
            ...
            ["B"] = {
                {"Cedo Blueprint","Blueprint",4.00},
                {"Cedo Barrel","Blueprint",4.00},
                {"Cedo Receiver","Blueprint",4.00},
                {"Cedo Stock","Blueprint",4.00},
                {"Meso P4","Relic",8.00},
                {"Meso C6","Relic",8.00},
                {"Meso I1","Relic",8.00},
                {"Meso P2","Relic",8.00},
            ...
            ["C"] = {
                {"Necramech Aviator","Mod",4.00},
                {"Necramech Rage","Mod",4.00},
                {"Necramech Enemy Sense","Mod",4.00},
                {"Necramech Deflection","Mod",4.00},
                {"Necramech Rebuke","Mod",4.00},
                {"Necramech Repair","Mod",4.00},
                {"Necramech Augur","Mod",4.00},
                {"Lith D4","Relic",8.00},
                {"Lith B8","Relic",8.00},
                {"Lith G3","Relic",8.00},
                {"Lith P5","Relic",8.00},
        ...
        Rewards = {
            ["A"] = {
                {"Redirection","Mod",20.00},
                {"Oxium","Resource",20.00,100},
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Iradite","Resource",20.00,15},
            },
            ["B"] = {
                {"Pressure Point","Mod",20.00},
                {"Cryotic","Resource",20.00,100},
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Grokdrul","Resource",20.00,15},
            },
            ["C"] = {
                {"Vitality","Mod",20.00},
                {"Plastids","Resource",20.00,200},
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Nistlepod","Resource",20.00,15},
            },
          },
        },
        { Type = "Cetus Bounty",
        ...
        Rewards = {
            ["A"] = {
                {"Steel Fiber","Mod",25.00},
                {"Oxium","Resource",25.00,200},
                {"Credits Cache","Credits",25.00,2500},
                {"Endo","Endo",25.00,100},
            },
            ["B"] = {
                {"Energy Inversion","Mod",25.00},
                {"Cryotic","Resource",25.00,200},
                {"Credits Cache","Credits",25.00,2500},
                {"Endo","Endo",25.00,100},
            },
            ["C"] = {
                {"Point Strike","Mod",25.00},
                {"Circuits","Resource",25.00,300},
                {"Credits Cache","Credits",25.00,2500},
                {"Endo","Endo",25.00,100},
            },
          },
        ...
        Rewards = {
            ["A"] = {
                {"Steel Fiber","Mod",14.50},
                {"Oxium","Resource",14.50,200},
                {"Credits Cache","Credits",14.50,2500},
                {"Endo","Endo",14.50,100},
            ...
            ["B"] = {
                {"Energy Inversion","Mod",14.50},
                {"Cryotic","Resource",14.50,200},
                {"Credits Cache","Credits",14.50,2500},
                {"Endo","Endo",14.50,100},
                {"Gara Systems Blueprint","Blueprint",9.16},
            ...
            ["C"] = {
                {"Point Strike","Mod",14.50},
                {"Circuits","Resource",14.50,300},
                {"Credits Cache","Credits",14.50,2500},
                {"Endo","Endo",14.50,100},
                {"Gara Systems Blueprint","Blueprint",9.16},
        ...
        Rewards = {
            ...
            ["B"] = {
                ...
                {"Vazarin Lens","Resource",8.60},
                {"Unairu Lens","Resource",8.60},
                {"Endo","Endo",20.43,200},
                {"Gara Neuroptics Blueprint","Blueprint",8.60},
                {"Gladiator Might","Mod",8.60},
        ...
        Rewards = {
            ...
            ["C"] = {
                {"Cetus Wisp","Resource",20.00},
                {"Vigilante Pursuit","Mod",20.00},
                {"Revenant Chassis Blueprint","Blueprint",20.00},
                {"Neo B6","Relic",35.00},
                {"Gladiator Finesse","Mod",5.00},
            },
          },
        },
        { Type = "Cetus Bounty",
        ...
        Rewards = {
            ["A"] = {
                {"Breath Of The Eidolon","Resource",50.00,5},
                {"Endo","Endo",50.00,400},
            },
            ["B"] = {
                {"Breath Of The Eidolon","Resource",50.00,5},
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Revenant Neuroptics Blueprint","Blueprint",10.20},
            },
            ["B"] = {
                {"Cetus Wisp","Resource",20.41,2},
                {"Kuva","Resource",7.14,300},
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Hunter Munitions","Mod",11.90},
                {"Stubba Blueprint","Blueprint",5.95},
                {"Cetus Wisp","Resource",11.90},
                {"Breath Of The Eidolon","Resource",5.95,5},
                {"Neo N14","Relic",22.62},
                {"Hunter Track","Mod",11.90},
        ...
        Rewards = {
            ["A"] = {
                {"Encrypted Journal Fragment","Fragments",23.81},
                {"Hunter Synergy","Mod",11.90},
                {"Quartakk Blueprint","Blueprint",5.95},
                {"Cetus Wisp","Resource",11.90},
                {"Breath Of The Eidolon","Resource",5.95,5},
                {"Neo Z7","Relic",22.62},
                {"Hunter Command","Mod",11.90},
                {"Nitain Extract","Resource",5.95},
            },
          },
        },
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Mytocardia Spore","Resource",20.00,5},
                {"Training Debt-Bond","Resource",20.00,2},
            },
            ["B"] = {
                {"Cryotic","Resource",20.00,100},
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Thermal Sludge","Resource",20.00,5},
                {"Training Debt-Bond","Resource",20.00,2},
            },
            ["C"] = {
                {"Plastids","Resource",20.00,100},
                {"Credits Cache","Credits",20.00,1500},
                {"Endo","Endo",20.00,50},
                {"Gorgaricus Spore","Resource",20.00,5},
                {"Training Debt-Bond","Resource",20.00,2},
            },
          },
        },
        ...
        Rewards = {
            ["A"] = {
                {"Mytocardia Spore","Resource",20.00,15},
                {"Oxium","Resource",20.00,200},
                {"Credits Cache","Credits",20.00,2500},
                {"Endo","Endo",20.00,100},
                {"Shelter Debt-Bond","Resource",20.00,2},
            },
            ["B"] = {
                {"Thermal Sludge","Resource",20.00,15},
                {"Cryotic","Resource",20.00,200},
                {"Credits Cache","Credits",20.00,2500},
                {"Endo","Endo",20.00,100},
                {"Shelter Debt-Bond","Resource",20.00,2},
            },
            ["C"] = {
                {"Gorgaricus Spore","Resource",20.00,15},
                {"Nano Spores","Resource",20.00,200},
                {"Credits Cache","Credits",20.00,2500},
                {"Endo","Endo",20.00,100},
                {"Shelter Debt-Bond","Resource",20.00,2},
            },
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Garuda Systems Blueprint","Blueprint",6.90},
                {"Tepa Nodule","Resource",6.90,5},
                {"Lith M7","Relic",10.34},
                {"Synth Charge","Mod",6.90},
            },
            ["B"] = {
        ...
        Rewards = {
            ["A"] = {
                {"Madurai Lens","Resource",20.00},
                {"Endo","Endo",40.00,200},
                {"Circuits","Resource",20.00,300},
                {"Medical Debt-Bond","Resource",20.00,2},
            },
            ["B"] = {
                {"Unairu Lens","Resource",20.00},
                {"Endo","Endo",40.00,200},
                {"Plastids","Resource",20.00,300},
                {"Medical Debt-Bond","Resource",20.00,2},
            },
            ["C"] = {
                {"Naramon Lens","Resource",20.00},
                {"Endo","Endo",40.00,200},
                {"Rubedo","Resource",20.00,300},
                {"Medical Debt-Bond","Resource",20.00,2},
            },
          },
        },
        ...
        Rewards = {
            ["A"] = {
                {"Madurai Lens","Resource",12.50},
                {"Endo","Endo",25.00,200},
                {"Circuits","Resource",12.50,300},
                {"Medical Debt-Bond","Resource",12.50,2},
                {"Garuda Neuroptics Blueprint","Blueprint",12.50},
                {"Meso E5","Relic",25.00},
            },
            ["B"] = {
                {"Unairu Lens","Resource",12.50},
                {"Endo","Endo",25.00,200},
                {"Plastids","Resource",12.50,300},
                {"Medical Debt-Bond","Resource",12.50,2},
                {"Garuda Neuroptics Blueprint","Blueprint",12.50},
                {"Meso E5","Relic",25.00},
            },
            ["C"] = {
                {"Naramon Lens","Resource",12.50},
                {"Endo","Endo",25.00,200},
                {"Rubedo","Resource",12.50,300},
                {"Medical Debt-Bond","Resource",12.50,2},
                {"Garuda Neuroptics Blueprint","Blueprint",12.50},
                {"Meso E5","Relic",25.00},
            },
        ...
        Rewards = {
            ["A"] = {
                {"Garuda Neuroptics Blueprint","Blueprint",25.00},
                {"Meso E5","Relic",50.00},
                {"Synth Deconstruct","Mod",25.00},
            },
            ["B"] = {
                {"Garuda Neuroptics Blueprint","Blueprint",25.00},
                {"Meso E5","Relic",50.00},
                {"Mecha Recharge","Mod",25.00},
            },
            ["C"] = {
                {"Garuda Neuroptics Blueprint","Blueprint",25.00},
                {"Meso E5","Relic",50.00},
                {"Tek Enhance","Mod",25.00},
            },
          },
        },
        { Type = "Fortuna Bounty",
        ...
        Rewards = {
            ["A"] = {
                {"Endo","Endo",50.00,400},
                {"Familial Debt-Bond","Resource",25.00,2},
                {"Credits Cache","Credits",25.00,10000},
            },
            ["B"] = {
                {"Endo","Endo",50.00,400},
                {"Familial Debt-Bond","Resource",25.00,2},
            ...
            ["C"] = {
                {"Endo","Endo",50.00,400},
                {"Neurodes","Resource",12.50},
                {"Orokin Cell","Resource",12.50},
                {"Familial Debt-Bond","Resource",25.00,2},
            },
          },
        },
        ...
        Rewards = {
            ["A"] = {
                {"Gyromag Systems","Resource",25.00,5},
                {"Lith D4 (Radiant)","Relic",15.00},
                {"Quick Reload","Mod",15.00},
                {"Atmo Systems","Resource",10.00,5},
                {"Vega Toroid","Resource",12.50,3},
                {"Lith B8 (Radiant)","Relic",12.50},
                {"Repeller Systems","Resource",7.50,3},
        ...
        Rewards = {
            ["A"] = {
                {"Gyromag Systems","Resource",25.00,5},
                {"Lith G3","Relic",15.00},
                {"Resolute Focus","Mod",15.00},
                {"Atmo Systems","Resource",10.00,5},
                {"Calda Toroid","Resource",12.50,3},
                {"Meso P4 (Radiant)","Relic",12.50},
                {"Repeller Systems","Resource",7.50,3},
        ...
        Rewards = {
            ["A"] = {
                {"Gyromag Systems","Resource",25.00,5},
                {"Meso I1 (Radiant)","Relic",15.00},
                {"Marked Target","Mod",15.00},
                {"Atmo Systems","Resource",10.00,5},
                {"Sola Toroid","Resource",12.50,3},
                {"Neo N14 (Radiant)","Relic",12.50},
                {"Repeller Systems","Resource",7.50,3},
        ...
        Rewards = {
            ["A"] = {
                {"Meso E5","Relic",33.33},
                {"Xaku Neuroptics Blueprint","Blueprint",10.00},
        ...
        Rewards = {
            ["A"] = {
                {"Ayatan Amber Star","Ayatan Sculpture",50.00},
                {"Endo","Endo",25.00,250},
                {"Lith M7","Relic",10.00},
                {"Carnis Mandible","Mod",5.00},
                {"Jugulus Barbs","Mod",5.00},
                {"Saxum Thorax","Mod",5.00},
            },
            ["B"] = {
                {"Ayatan Amber Star","Ayatan Sculpture",40.00},
                {"Endo","Endo",20.00,250},
                {"Lith K5","Relic",12.50},
                {"Meso E5","Relic",12.50},
                {"Carnis Mandible","Mod",5.00},
        ...
        Rewards = {
            ["A"] = {
                {"Ayatan Amber Star","Ayatan Sculpture",25.00},
                {"Endo","Endo",12.50,250},
                {"Lith M7","Relic",5.00},
                {"Carnis Mandible","Mod",2.50},
                {"Jugulus Barbs","Mod",2.50},
                {"Saxum Thorax","Mod",2.50},
                {"Ayatan Amber Star","Ayatan Sculpture",25.00},
                {"Endo","Endo",12.50,500},
                {"Meso E5","Relic",5.00},
                {"Carnis Carapace","Mod",2.50},
                {"Jugulus Carapace","Mod",2.50},
                {"Saxum Carapace","Mod",2.50},
            },
            ["B"] = {
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Endo","Endo",12.50,750},
                {"Neo B6","Relic",5.00},
                {"Carnis Stinger","Mod",2.50},
                {"Jugulus Spines","Mod",2.50},
                {"Saxum Spittle","Mod",2.50},
            },
            ["B"] = {
                {"Ayatan Amber Star","Ayatan Sculpture",25.00},
                {"Endo","Endo",12.50,500},
        ...
        Rewards = {
            ["A"] = {
                {"Endo","Endo",45.00,750},
                {"Unairu Lens","Resource",17.50},
                {"Madurai Lens","Resource",17.50},
                {"Hydraulic Crosshairs","Mod",12.50},
                {"Fass Residue","Resource",7.50,5},
            },
            ["B"] = {
                {"Endo","Endo",45.00,750},
                {"Unairu Lens","Resource",17.50},
                {"Madurai Lens","Resource",17.50},
                {"Focused Defense","Mod",12.50},
                {"Vome Residue","Resource",7.50,5},
            },
            ["C"] = {},
          },
        },
        ...
        Rewards = {
            ["A"] = {
                ...
                {"Neo B6","Relic",25.00},
                {"Xaku Systems Blueprint","Blueprint",7.50},
        ...
        Rewards = {
            ["A"] = {
                {"Endo","Endo",18.00,750},
                {"Unairu Lens","Resource",7.00},
                {"Madurai Lens","Resource",7.00},
                {"Hydraulic Crosshairs","Mod",5.00},
                {"Fass Residue","Resource",3.00,5},
                {"Neo B6","Relic",20.00},
                {"Xaku Systems Blueprint","Blueprint",6.00},
                {"Laser Sight","Mod",7.00},
                {"Blood Rush","Mod",7.00},
                {"Argon Scope","Mod",20.00},
            },
            ["B"] = {
                {"Endo","Endo",18.00,750},
                {"Unairu Lens","Resource",7.00},
                {"Madurai Lens","Resource",7.00},
                {"Focused Defense","Mod",5.00},
                {"Vome Residue","Resource",3.00,5},
                {"Neo B6","Relic",20.00},
                {"Xaku Systems Blueprint","Blueprint",6.00},
                {"Targeting Subsystem","Mod",7.00},
                {"Guided Ordnance","Mod",7.00},
                {"Narrow Barrel","Mod",20.00},
            },
            ["C"] = {},
          },
        },
        ...
        Rewards = {
            ["A"] = {
                {"Neo B6","Relic",33.33},
                {"Xaku Systems Blueprint","Blueprint",10.00},
        ...
        Rewards = {
            ["A"] = {
                {"Residual Boils","Resource",25.00},
                {"Necramech Redirection","Mod",12.50},
                {"Orokin Orientation Matrix","Resource",6.25,2},
                {"Meso P4","Relic",6.25},
                {"Residual Shock","Resource",15.00},
                {"Necramech Steel Fiber","Mod",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,2},
                {"Neo N14","Relic",1.88},
                {"Neo N13","Relic",1.88},
                {"Theorem Contagion","Resource",10.00},
                {"Necramech Thrusters","Mod",4.00},
                {"Damaged Necramech Weapon Barrel","Resource",3.00},
                {"Scintillant","Resource",2.00,3},
                {"Orokin Animus Matrix","Resource",0.50,2},
                {"Axi B3","Relic",0.50},
            },
            ["B"] = {
                {"Residual Malodor","Resource",25.00},
                {"Necramech Redirection","Mod",12.50},
                {"Orokin Orientation Matrix","Resource",6.25,2},
                {"Meso C6","Relic",6.25},
                {"Residual Viremia","Resource",15.00},
                {"Necramech Efficiency","Mod",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,2},
                {"Neo Z7","Relic",3.75},
                {"Theorem Contagion","Resource",10.00},
                {"Necramech Thrusters","Mod",4.00},
                {"Damaged Necramech Weapon Receiver","Resource",3.00},
                {"Scintillant","Resource",2.00,3},
                {"Orokin Animus Matrix","Resource",0.50,2},
                {"Neo Z7","Relic",0.50},
            },
            ["C"] = {
                {"Theorem Demulcent","Resource",25.00},
                {"Necramech Redirection","Mod",12.50},
                {"Orokin Orientation Matrix","Resource",6.25,2},
                {"Neo Z7","Relic",6.25},
                {"Theorem Infection","Resource",15.00},
                {"Necramech Reach","Mod",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,2},
                {"Neo N13","Relic",3.75},
                {"Theorem Contagion","Resource",10.00},
                {"Necramech Thrusters","Mod",4.00},
                {"Damaged Necramech Weapon Stock","Resource",3.00},
                {"Scintillant","Resource",2.00,3},
                {"Orokin Animus Matrix","Resource",0.50,2},
                {"Neo Z7","Relic",0.50},
            },
        ...
        Rewards = {
            ["A"] = {
                {"Residual Boils","Resource",25.00},
                {"Necramech Blitz","Mod",12.50},
                {"Arum Spinosa Blueprint","Blueprint",6.25},
                {"Orokin Orientation Matrix","Resource",3.13,3},
                {"Meso N10","Relic",3.13},
                {"Residual Shock","Resource",15.00},
                {"Necramech Slipstream","Mod",7.50},
                {"Arum Spinosa Guard","Blueprint",3.75},
                {"Orokin Ballistics Matrix","Resource",1.88,3},
                {"Neo P2","Relic",0.94},
                {"Neo N13","Relic",0.94},
                {"Theorem Contagion","Resource",10.00},
                {"Necramech Seismic Wave","Mod",4.00},
                {"Damaged Necramech Weapon Barrel","Resource",3.00},
                {"Arum Spinosa Rivet","Blueprint",2.00},
                {"Orokin Animus Matrix","Resource",0.50,3},
                {"Neo B7","Relic",0.50},
            },
            ["B"] = {
                {"Residual Malodor","Resource",25.00},
        ...
        Rewards = {
            ["A"] = {
                {"Residual Boils","Resource",50.00},
                {"Necramech Redirection","Mod",25.00},
                {"Orokin Orientation Matrix","Resource",12.50,2},
                {"Meso P4","Relic",12.50},
            },
            ["B"] = {
                {"Residual Malodor","Resource",50.00},
                {"Necramech Redirection","Mod",25.00},
                {"Orokin Orientation Matrix","Resource",12.50,2},
                {"Meso C6","Relic",12.50},
            },
            ["C"] = {
                {"Theorem Demulcent","Resource",50.00},
                {"Necramech Redirection","Mod",25.00},
                {"Orokin Orientation Matrix","Resource",12.50,2},
                {"Neo Z7","Relic",12.50},
            },
        ...
        Rewards = {
            ...
            ["B"] = {
                {"Residual Malodor","Resource",31.25},
                {"Necramech Redirection","Mod",15.63},
                {"Orokin Orientation Matrix","Resource",7.81,2},
                {"Meso C6","Relic",7.81},
                {"Residual Viremia","Resource",18.75},
                {"Necramech Efficiency","Mod",9.38},
                {"Orokin Ballistics Matrix","Resource",4.69,2},
                {"Neo Z7","Relic",4.69},
            },
            ["C"] = {
                {"Theorem Demulcent","Resource",31.25},
                {"Necramech Redirection","Mod",15.63},
                {"Orokin Orientation Matrix","Resource",7.81,2},
                {"Neo Z7","Relic",7.81},
                {"Theorem Infection","Resource",18.75},
        ...
        { Type = "Arcana Isolation Vault Bounty",
        Tier = "30-40-3",
        Name = "Lvl&nbsp;30-40<br />Stage 4 of 5",
        ...
        Rewards = {
            ["A"] = {
                {"Residual Shock","Resource",30.00},
                {"Necramech Steel Fiber","Mod",15.00},
                {"Orokin Ballistics Matrix","Resource",7.50,2},
                {"Neo N14","Relic",3.75},
                {"Neo N13","Relic",3.75},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Thrusters","Mod",8.00},
                {"Damaged Necramech Weapon Barrel","Resource",6.00},
                {"Scintillant","Resource",4.00,3},
                {"Orokin Animus Matrix","Resource",1.00,2},
                {"Axi O5","Relic",1.00},
            },
            ["B"] = {
                {"Residual Viremia","Resource",30.00},
                {"Necramech Efficiency","Mod",15.00},
                {"Orokin Ballistics Matrix","Resource",7.50,2},
                {"Neo Z7","Relic",7.50},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Thrusters","Mod",8.00},
                {"Damaged Necramech Weapon Receiver","Resource",6.00},
                {"Scintillant","Resource",4.00,3},
                {"Orokin Animus Matrix","Resource",1.00,2},
                {"Neo Z7","Relic",1.00},
            },
            ["C"] = {
                {"Theorem Infection","Resource",30.00},
                {"Necramech Reach","Mod",15.00},
                {"Orokin Ballistics Matrix","Resource",7.50,2},
                {"Neo N13","Relic",7.50},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Thrusters","Mod",8.00},
                {"Damaged Necramech Weapon Stock","Resource",6.00},
                {"Scintillant","Resource",4.00,3},
                {"Orokin Animus Matrix","Resource",1.00,2},
                {"Neo P2","Relic",1.00},
            },
        ...
        Rewards = {
            ["A"] = {
                {"Residual Boils","Resource",50.00},
                {"Necramech Blitz","Mod",25.00},
                {"Arum Spinosa Blueprint","Blueprint",12.50},
        ...
        Rewards = {
            ["A"] = {
                {"Residual Shock","Resource",30.00},
                {"Necramech Slipstream","Mod",15.00},
                {"Arum Spinosa Guard","Blueprint",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,3},
                {"Neo P2","Relic",1.88},
                {"Neo N13","Relic",1.88},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Seismic Wave","Mod",8.00},
                {"Damaged Necramech Weapon Barrel","Resource",6.00},
                {"Arum Spinosa Rivet","Blueprint",4.00},
                {"Orokin Animus Matrix","Resource",1.00,3},
                {"Neo B7","Relic",1.00},
            },
            ["B"] = {
                {"Residual Viremia","Resource",30.00},
                {"Necramech Continuity","Mod",15.00},
                {"Arum Spinosa Guard","Blueprint",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,3},
                {"Neo B7","Relic",3.75},
                {"Theorem Contagion","Resource",20.00},
        ...
        Rewards = {
            ["A"] = {
                {"Residual Boils","Resource",50.00},
                {"Necramech Fury","Mod",25.00},
                {"Sporothrix Blueprint","Blueprint",12.50},
        ...
        Rewards = {
            ["A"] = {
                {"Residual Shock","Resource",30.00},
                {"Necramech Stretch","Mod",15.00},
                {"Sporothrix Barrel","Blueprint",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,4},
                {"Neo N15","Relic",1.88},
                {"Neo N13","Relic",1.88},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Streamline","Mod",8.00},
                {"Damaged Necramech Weapon Barrel","Resource",6.00},
                {"Orokin Animus Matrix","Resource",3.00,4},
                {"Axi A13","Relic",3.00},
            },
            ["B"] = {
                {"Residual Viremia","Resource",30.00},
                {"Necramech Hydraulics","Mod",15.00},
                {"Sporothrix Receiver","Blueprint",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,4},
                {"Neo N14","Relic",3.75},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Streamline","Mod",8.00},
            ...
            ["C"] = {
                {"Theorem Infection","Resource",30.00},
                {"Necramech Friction","Mod",15.00},
                {"Sporothrix Stock","Blueprint",7.50},
                {"Orokin Ballistics Matrix","Resource",3.75,4},
                {"Neo N13","Relic",3.75},
                {"Theorem Contagion","Resource",20.00},
                {"Necramech Streamline","Mod",8.00},
        ...
        { Type = "Baro Ki'Teer",
          ...
          Rewards = {
            [""] = {
              ...
              {"Combo Fury","Mod",100},
              {"Combo Killer","Mod",100},
              {"Primed Firestorm","Mod",100},
              {"Primed Fulmination","Mod",100},
            },
          },
        },
        { Type = "Daily Tribute",
        ...
        { Type = "Empyrean",
          ...
          Rewards = {
            ["A"] = {
                {"Dirac","Resource",20.00,100},
                {"Dirac","Resource",10.00,200},
                {"Riven Sliver","Resource",1.00,2},
                {"Lavan Engines Mk I","Blueprint",8.00},
                {"Lavan Reactor Mk I","Blueprint",8.00},
                {"Lavan Shield Array Mk I","Blueprint",8.00},
                {"Vidar Engines Mk I","Blueprint",8.00},
                {"Vidar Reactor Mk I","Blueprint",8.00},
                {"Vidar Shield Array Mk I","Blueprint",8.00},
                {"Lith D4","Relic",3.00},
                {"Lith B8","Relic",3.00},
                {"Lith G3","Relic",3.00},
                {"Lith P5","Relic",3.00},
        ...
        { Type = "Empyrean",
          ...
          Rewards = {
            ["A"] = {
                {"Dirac","Resource",20.00,150},
                {"Dirac","Resource",10.00,300},
                {"Riven Sliver","Resource",5.50,2},
                {"Forma Blueprint","Blueprint",2.50},
                {"Lavan Engines Mk II","Blueprint",8.00},
                {"Lavan Reactor Mk II","Blueprint",8.00},
                {"Lavan Shield Array Mk II","Blueprint",8.00},
                {"Vidar Engines Mk II","Blueprint",8.00},
                {"Vidar Reactor Mk II","Blueprint",8.00},
                {"Vidar Shield Array Mk II","Blueprint",8.00},
                {"Meso C6","Relic",2.00},
                {"Meso P2","Relic",2.00},
                {"Meso K3","Relic",2.00},
                {"Meso P4","Relic",2.00},
        ...
        { Type = "Empyrean",
          ...
          Rewards = {
            ["A"] = {
                {"Rush Repair Drone","Resource",0.50},
                {"Dirac","Resource",20.00,400},
                {"Dirac","Resource",10.00,1000},
                {"Riven Sliver","Resource",5.00,3},
                {"Forma Blueprint","Blueprint",2.50},
                {"Lavan Engines Mk III","Blueprint",8.00},
                {"Lavan Reactor Mk III","Blueprint",8.00},
                {"Lavan Shield Array Mk III","Blueprint",8.00},
                {"Vidar Engines Mk III","Blueprint",8.00},
                {"Vidar Reactor Mk III","Blueprint",8.00},
                {"Vidar Shield Array Mk III","Blueprint",8.00},
                {"Neo T2","Relic",2.00},
                {"Neo N14","Relic",2.00},
                {"Neo N13","Relic",2.00},
                {"Neo Z7","Relic",2.00},
        ...
        { Type = "Empyrean",
          ...
          Rewards = {
            ["A"] = {
                {"Spectra Vandal Blueprint","Blueprint",8.60},
                {"Spectra Vandal Barrel","Blueprint",8.60},
                {"Spectra Vandal Chassis","Blueprint",8.60},
                {"Spectra Vandal Handle","Blueprint",8.60},
                {"Fresnels","Resource",8.60,3},
                {"Kesslers","Resource",8.60,4},
                {"Dirac","Resource",8.60,50},
                {"Dirac","Resource",7.52,100},
                {"Dirac","Resource",8.60,100},
                {"Dirac","Resource",7.52,200},
                {"Dirac","Resource",8.60,150},
    ...
    ["Syndicates"] ={
        ...
        { Name = "Necraloid",
            Offerings = {
                {"Necramech Vitality","Mod",10000},
                {"Necramech Refuel","Mod",10000},
                {"Necramech Intensify","Mod",25000},
                {"Necramech Pressure Point","Mod",25000},
                {"Necramech Efficiency","Mod",25000},
                {"Necramech Drift","Mod",25000},
                {"Necramech Friction","Mod",25000},
                {"Necramech Flow","Mod",25000},
            },
        },
    },
    ["Enemies"] = {
        ...
        { Name = "Leaping Thrasher",
          ...
          Mods = {
              ...
              {"Endo",25.29,15},
              {"Fetch",7.37},
              {"Volatile Quick Return",7.37},
              {"Endo",7.37,50},
              {"Condition Overload",0.5},
              {"Volatile Rebound",0.5},
              {"Defiled Snapdragon",0.5},
              {"Endo",0.5,80},
          },
        },
        ...
        { Name = "Deimos Carnis Rex",
          ModChance = 10,
          Mods = {
            {"Carnis Mandible",75.88},
            {"Carnis Carapace",22.11},
            {"Carnis Stinger",2.01},
          },
        },
        ...
        { Name = "Deimos Leaper",
          ...
          Mods = {
            {"Assault Mode",37.94},
            {"Endo",37.94,15},
            {"Fatal Acceleration",11.06},
            {"Cleanse Infested",11.06},
            {"Spinning Needle",1.01},
            {"Seismic Palm",1.01},
          },
        },
